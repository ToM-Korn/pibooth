        ...
        odict((
            ...
            ("orientation",
             ('landscape', "This adjusts how the layout on the screen is built if the monitor or "
              ...
              "Window Orientatation", ['landscape', 'portrait'])),
            ("background",
                ((0, 0, 0),
        ...
        odict((
            ...
            ("backgrounds",
                ((255, 255, 255),
                 ...
                 None, None)),
            ("pic_postfix",
             ("_pibooth", "What should be added to picture during saving it to the harddrive?",
              "Postfix for file", "_pibooth")),
        ))
     ),
    ("CAMERA",
        odict((
            ...
            ("imageformat",
             ("'Large Normal JPEG'",
              ...
              "and upload to Cloud Storage if used.", "Canon Image Format", ["'Large Normal JPEG'"])),
            ("flip",
                (True,
        ...
        odict((
            ...
            ('format',
             ('standard', 'Defines what format is printed.'
              ...
              "Printed Format", ['standard', 'stripe'])),
            ("printer_options",
                ({},
